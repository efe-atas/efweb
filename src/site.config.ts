...
const config: SiteConfig = {
  ...
  site: 'https://efeatas.dev',
  // The name of your site, used in the title and for SEO.
  title: 'İsmail Efe Ataş',
  // The description of your site, used for SEO and RSS feed.
  description:
    'A personal website of İsmail Efe Ataş',
  // The author of the site, used in the footer, SEO, and RSS feed.
  author: 'İsmail Efe Ataş',
  // Keywords for SEO, used in the meta tags.
  tags: ['Astro', 'Personal Website', 'Efe Ataş', 'tedu'],
  ...
  socialLinks: {
    github: 'https://github.com/efe-atas',
    email: 'iefeatas@gmail.com',
    linkedin: 'https://www.linkedin.com/in/efeatas/',
    twitter: 'https://x.com/iefeatas',
